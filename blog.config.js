...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CINZY', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '无', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cinzy.com', // 网站地址
  ...
  CONTACT_GITHUB: 'https://github.com/cinzy', // process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://www.cinzy.com/avatar.svg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  FONT_AWESOME:
    ...
    'https://cdn.staticfile.net/font-awesome/6.4.0/css/all.min.css', // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css https://cdn.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://blog.cinzy.com/js/count.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '实验室', // 站点描述，被notion中的页面描述覆盖
